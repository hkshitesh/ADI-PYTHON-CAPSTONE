...
def add():
    ...
    print(sql, (name, age, gender, major))
...
def update():
    ...
    sql = f"UPDATE students SET age = {age} WHERE name = '{name}'"
    mycursor.execute(sql)
    sql = f"UPDATE students SET gender = '{gender}' WHERE name = '{name}'"
    mycursor.execute(sql)
    sql = f"UPDATE students SET major = '{major}' WHERE name = '{name}'"
    mycursor.execute(sql)
    mydb.commit()
